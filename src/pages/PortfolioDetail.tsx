            ...
            <div className="offset-lg-1 col-lg-5">
              <div className="portfolio_right_text mt-30">
                ...
                <p>
                  ...
                  there saw you sea doesn't from morning called hath air morning
                  herb appear hath replenish that created fill their lesser.
                </p>
                <ul className="list">
                  <li>
                    <span>Rating</span>: <i className="fa fa-star"></i>
